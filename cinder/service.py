...
service_opts = [
    ...
    cfg.StrOpt('kims_connection',
               default="mysql://key_user:kmis_pass@10.140.12.201:33306/kims",
               help='kims db connection url'),
    cfg.IntOpt('kims_default_pool_size',
               default=100,
               help='kims mysql db default pool size'),
    cfg.IntOpt('kims_max_pool_size',
               default=100,
               help='kims mysql db default pool size'),
    cfg.IntOpt('kims_rotation_time',
               default=30,
               help='kims keys rotation time '),
